...
"
" Copyright (c) 2010 sagata All Rights Reserved.
"
" Maintainer: meetbill <meetbill@163.com>
"    Created: 2014-01-01
" LastChange: 2017-09-28
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+2, "\# Author: sagata") 
	...
	if &filetype == 'cpp'
		...
		call append(line(".")+1, "	> Author: sagata") 
...
" DoxygenToolkit{{{
"2014-8-13
"let g:DoxygenToolkit_authorName="sagata, "
